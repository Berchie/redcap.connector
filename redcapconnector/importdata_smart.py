...
um_fieldnames = ["id_um","redcap_event_name","redcap_data_access_group","visit_no_sid",'samplec_heparin', 'vdate_heparin', "sptaken_heparin", 'blab_dat', 'b03_biochemistry_performed', 'c01_date_and_time_of_bioch', "pro_heparin","c10_2_if_done","c07_heparin", "c07_2_if_done","ggt_heparin","c09_2_if_done","alb_heparin","c05_2_if_done","alp_heparin","c08_2_if_done","c04_1_bild","c04_1", "alt_heparin","c05_2_if_done_2","c03_1_bilt","c03_2_if_done"]
sm_fieldnames = ["id_um","redcap_event_name","redcap_data_access_group","visit_no_sid",'samplec_heparin', 'vdate_heparin', "sptaken_heparin", 'blab_dat', 'b03_biochemistry_performed', 'c01_date_and_time_of_bioch', "urea_heparin","c11_2_if_done","gluc_heparin", "c13_2_if_done","crea_heparin","c12_2_if_done", "lact_heparin", "c14_2_if_done"]
                ...
                with open(csv_file, 'a', newline='', encoding='utf-8-sig') as data_file:
                    ...
                    for row in json_results:
                        new_row = {
                            ...
                            "visitp_edta": row.get("visitp_edta", ""),
                            "samplec_edta": row.get("samplec_edta",""),
                            "vdate_heparin_la": row["vdate_heparin_la"],
                            "blood_la": row["blood_la"],
                            "a04_initials_of_phlebotomi_la": row["a04_initials_of_phlebotomi_la"],
                            "dat_edta": row["dat_edta"],
                            "fblood_edta": row["fblood_edta"],
                            "c01_date_and_time_of_fbc": row["c01_date_and_time_of_fbc"],
                            "lab_edta": row["lab_edta"],
                    ...
                    for row in json_results:
                        if case_type == "UM":
                            new_row = {
                                ...
                                "samplec_heparin": row["samplec_heparin"],
                                "vdate_heparin": row["vdate_heparin"],
                                "sptaken_heparin": row["sptaken_heparin"],
                                "blab_dat": row["blab_dat"],
                                "b03_biochemistry_performed": row["b03_biochemistry_performed"],
                                "c01_date_and_time_of_bioch": row["c01_date_and_time_of_bioch"],
